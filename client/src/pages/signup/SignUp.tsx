...
const SignUp = () => {
    ...
    const registrationHandler = async () => {
        try {
            ...
            const response = await axios.post('http://localhost:5000/users/ru/data/v3/testmethods/docs/signup',body)
            setLoading(true);
            ...
            <div className={classes.signup}>
                    ...
                    <div>
                        ...
                        <div className={classes.button_block}>
                            <MyButton onClick={registrationHandler} disabled={!activeForm}>Sign up</MyButton>
                        </div>
